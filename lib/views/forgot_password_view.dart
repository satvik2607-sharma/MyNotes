        ...
        if (state is AuthStateForgotPassword) {
          ...
          if (state.exception != null) {
            await showErrorDialog(context,
                'We could not process your request. Please make sure you are a registered user, or if not, register a user by going back one step.');
          }
        }
      },
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                const Text(
                    'If you forgot your password, simply enter your mail and we will send you a password resent link'),
                TextField(
